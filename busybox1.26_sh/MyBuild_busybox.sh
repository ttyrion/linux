...
function build_busybox {
    ...
    sudo make ARCH=$DEFAULT_ARCH CROSS_COMPILE=$DEFAULT_CROSS_COMPILE LDFLAGS=--static install
    return $?
}

# Note: you should config it to build a static library(int the busybox setting)
